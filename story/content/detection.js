...
(function () {
  ...
  var plat = typeof navigator !== "undefined" ? (navigator.platform || "") : "";
  var isIOSPlatform = /iPhone|iPad|iPod/i.test(plat);

  if (ua.indexOf("Android") !== -1) {
    osLabel = "Android";
    osKey = "android";
  } else if (ua.indexOf("iPhone") !== -1 || ua.indexOf("iPad") !== -1 || ua.indexOf("iPod") !== -1 || isIOSPlatform) {
    osLabel = "iOS";
    osKey = "ios";
